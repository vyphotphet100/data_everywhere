...
public class Constant {
    ...
    public static class Paypal {
        ...
        public static final String cancelUrl = "http://data-everywhere.myftp.org/payment/paypal/cancel";
        public static final String returnUrl = "http://data-everywhere.myftp.org/payment/paypal/review_payment";
